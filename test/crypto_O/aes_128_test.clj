(ns crypto_O.aes-128-test
  (:import  [java.util Arrays]
            [java.nio ShortBuffer])
  (:require [clojure.test :refer :all]
            [crypto_O.aes-128 :refer :all]
...
(def ones-expanded (ShortBuffer/wrap (short-array [0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff
...
(def sequence-expanded (ShortBuffer/wrap (short-array [0x00 0x01 0x02 0x03 0x04 0x05 0x06 0x07 0x08 0x09 0x0a 0x0b 0x0c 0x0d 0x0e 0x0f
...
(def menchito-expanded (ShortBuffer/wrap (short-array [0x69 0x20 0xe2 0x99 0xa5 0x20 0x2a 0x6d 0x65 0x6e 0x63 0x68 0x69 0x74 0x6f 0x2a
...
(deftest test-roundtrip
  (testing "decrypting encryption"
    (let [key (ShortBuffer/wrap (short-array [0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff 0xff]))
          data (ShortBuffer/wrap (short-array [0x69 0x20 0xe2 0x99 0xa5 0x20 0x2a 0x6d 0x65 0x6e 0x63 0x68 0x69 0x74 0x6f 0x2a]))]
      (is (.equals data (decrypt-block key (encrypt-block key data)))))))
